	...
	<div class="content">
		...
		<div id="session_view">
		   <table border="1">
		     ...
		     <tr>
		     <td width="100">아이디</td>
		     <td width="200">${requestScope.user_id }</td>
		     <td width="200">${sessionScope.user_id } (${user_id })</td>
		     </tr>
		     <tr>
		     <td width="100">이름</td>
		     <td width="200">${requestScope.user_name }</td>
		     <td width="200">${sessionScope.user_name } (${user_name })</td>
		     </tr>
		     <tr>
		     <td width="100">로그인 시간</td>
		     <td width="200">
		     <fmt:formatDate value="${requestScope.login_time }" pattern="yyyy-MM-dd-a hh:mm:ss"/></td>
		     <fmt:formatDate value="${login_time }" pattern=""/>
		     <td width="200"> 
			...
			<div class="widget" style="position: absolute;top:-40px; left:700px">
				...
				<ul>
					...
					<li><h6><b class="light-gray">></b> <a href="#">Design</a><span class="light-gray"> (2)</span></h6></li>
						<li><h6><b class="light-gray">></b> <a href="remove_session.do">세션삭제</a><span class="light-gray"> (6)</span></h6></li>
