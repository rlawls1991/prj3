...
<body>
	...
	<div class="content">
		...
		<div id="include">
		<!-- WebContent의 JSP include -->
		<jsp:include page="/day0228/webcontent_include.jsp"/>
		<!-- WEB-INF/views의 JSP include -->
		<jsp:include page="/WEB-INF/views/day0228/views_include.jsp"/>
		<!-- x.do의 include : data를 사용하는 JSP include -->
		<jsp:include page="/include_test.do"/>
		</div>
