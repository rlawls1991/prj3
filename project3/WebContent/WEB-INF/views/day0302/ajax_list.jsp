...
<!-- Load CSS -->
<link href="/spring_mvc_prj/common1/css/style.css" rel="stylesheet" type="text/css" />
<!-- Load Icon Font -->
<link href="/spring_mvc_prj/common1/css/webfont.css" rel="stylesheet" type="text/css" />
<!-- Load jQuery library -->
<script type="text/javascript" src="https://ajax.googleapis.com/ajax/libs/jquery/2.0.3/jquery.min.js"></script>
<!-- Load jCarousel js -->
<script type="text/javascript" src="/spring_mvc_prj/common1/js/jquery.jcarousel.js"></script>
<!-- Load MixItUup js -->
<script type="text/javascript" src="/spring_mvc_prj/common1/js/jquery.mixitup.js"></script>
<!-- Load js -->
<script type="text/javascript" src="/spring_mvc_prj/common1/js/custom.js"></script>
<link rel="stylesheet" type="text/css" href="/spring_mvc_prj/common/css/main.css"/>
<script type="text/javascript">
  ...
  function searchDetail(num,subject){
	  
	  $.ajax({
		  url : "detail_thesis.do",
		  data:"num="+num,
		  type:"get",
		  dataType:"json",
		  error:function(xhr, data){
			  alert(xhr.status+"/"+xhr.statusText+"/"+data)
		  },success:function(json){
			  $("#t_subject").html(subject);
			  $("#t_content").html(json.content);
		  }
	  });
  }//searchDetail
</script>
...
<body>
	...
	<div class="blockquote main">
	   <div style="float:  right; margin-right: 60px; margin-top:20px">
	     ${requestScope.cookie_date}/${requestScope.cookie_name }
	   </div>
	</div>
	<!-- End BlockQuote -->
	...
	<div class="content">
		...
		<div id="thesis" class="section full">
			...
			<ul class="carousel" id="carousellatest">
                 <c:forEach var="stu" items="${thesis }">
				<!-- Start Single Block -->
				<li>
					<div class="section block">	
						<img src="../images/${stu.img }" style="width:220px; height:220px">
						<div class="content">
							<h5>${stu.name }</h5>
							<h6>${stu.thesis }</h6>
						</div>
						<div class="hover">
							<a href="javascript:searchDetail(${stu.num}, '${stu.thesis }');" class="hover content">
								<h2>+</h2>
								<h5>${stu.name }</h5>
								<h6>${stu.thesis }</h6>
						    </a>
	...
	<div class="content">
		...
		<div class="content sidebar" id="snippets" style="position:relative;">
			...
			<article class="post">				
				<div class="hover">	
					<div class="postimage">
						<img src="/spring_mvc_prj/common1/img/post1.jpg">
				...
				<h3><span id="t_subject">A boat</span></h3>
				<p><span id="t_content">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
				tempor incididunt ut labore et dolore magna aliqua.</span></p>
			...
			<article class="post">
				<div class="hover">	
					<div class="postimage">
						<img src="/spring_mvc_prj/common1/img/post2.jpg">
						<div class="posthover"><a class="openpost" href="javascript:void(0);" data-id="2">read more</a></div>
					</div>
					<div class="postinfo">
						<h6 class="mid-gray"><b class="dark-gray">Posted:</b> 17/9/13</h6>
			...
			<article class="post">				
				<div class="hover">	
					<div class="postimage">
						<img src="/spring_mvc_prj/common1/img/post3.jpg">
						<div class="posthover"><a class="openpost" href="javascript:void(0);" data-id="2">read more</a></div>
					</div>
					<div class="postinfo">
						<h6 class="mid-gray"><b class="dark-gray">Posted:</b> 17/9/13</h6>
